...
## Purpose
Adds content field slot components to the template builder, allowing users to drop field types into containers, mark them as required/optional, define page/slide boundaries, and enable free-positioning as an escape hatch.
...
- Optionally enable free-positioning for specific elements (escape hatch, not default)
...
- Free-positioning is an explicit opt-in per element, not a global mode
